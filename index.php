...
<?php if($_GET['msj'] == 'error_code'): ?>
    ...
    <div class="container">
        ...
        <div class="container">
            <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 2000;">
                <div class="modal-dialog">
                <div class="modal-content">
                <form data-toggle="validator" role="form" method="post" class="form-group" action="view/sendform.php" onsubmit="return validateform();">
                        ...
                        <div class="bs-example">
                            ...
                            <div class="form-group"> 
                             <!-- OPEN IMPORTACION DE CODIGO CAPTCHA -->
								...
								-->
								<div class="g-recaptcha" data-sitekey="6Lf_VSQTAAAAACDv0KUwEo4mdVgnoGDbQ9nemOH9"></div>
								
								<div id="valida_recaptcha" style="color: red; padding-left: 25px;"></div>
                            <!-- CIERRA -->
                            </div>
                            <!--
                            <div class="form-group">
